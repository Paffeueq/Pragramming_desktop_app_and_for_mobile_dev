...
def analyze_invoice_file(file_path):
    """Wysyla plik faktury do Azure DI API"""
...
\begin{itemize}
	...
	\item \textbf{Rozpoznanie:} \textbf{2025-12-12} (confidence: 91.60\%)
...
System wykazuje wysoką skuteczność w kluczowych obszarach przetwarzania dokumentów finansowych. Najlepiej radzi sobie z ekstrakcją kwot finansowych, identyfikacją walut oraz rozpoznawaniem liczb ilościowych, osiągając poziomy pewności zazwyczaj przekraczające 90%. Rozpoznawanie dat jest stabilne i w dużej mierze niezależne od formatu zapisu, a analiza tabel pozycji pozwala bezproblemowo wyodrębniać kilka pozycji jednocześnie.
